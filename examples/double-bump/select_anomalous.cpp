...
bool deltaXmaxCut(const double xmax1, const double xmax2)
{
...
)
{
  ...
  auto statisticalSelection = df
    .Filter(deltaXmaxCut, {"ghDoubleFit.xmax_1", "ghDoubleFit.xmax_2"});

  TCanvas canvas;
  canvas.Print("plot.pdf[");

  statisticalSelection.Foreach([&](
    TGraph dedx
  ){
    dedx.Draw("a*");
    canvas.Print("plot.pdf");
